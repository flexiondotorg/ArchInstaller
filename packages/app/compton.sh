...
if [ ! -f "/home/${SUDO_USER}/.compton.conf" ]; then
    cat << COMPTON > "/home/${SUDO_USER}/.compton.conf"
# Shadow
...
chown ${SUDO_USER}:users /home/${SUDO_USER}/.compton.conf
chmod 644 /home/${SUDO_USER}/.compton.conf
